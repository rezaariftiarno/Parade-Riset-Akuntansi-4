...
<div class="wrapper-info">
	...
	<div class="col-right">			
			<div class="centerbold">
				<hr />
				<a href="<?php echo esc_url(SKT_COMPLETE_SKTTHEMES_LIVE_DEMO); ?>" target="_blank"><?php esc_attr_e('Live Demo', 'skt-complete'); ?></a> | 
				<a href="<?php echo esc_url(SKT_COMPLETE_SKTTHEMES_PRO_THEME_URL); ?>"><?php esc_attr_e('Buy Pro', 'skt-complete'); ?></a> | 
				<a href="<?php echo esc_url(SKT_COMPLETE_SKTTHEMES_THEME_DOC); ?>" target="_blank"><?php esc_attr_e('Documentation', 'skt-complete'); ?></a>
